...
JWT + bcryptjs — autenticación segura y cifrado de claves. HTML + CSS + JavaScript — frontend sin frameworks.
...
Configurar el archivo .env Creá un archivo .env en la raíz con estos datos (no lo subas a GitHub porque te desaprueban): Ini, TOML
DB_HOST=localhost DB_PORT=3306 DB_NAME=soporte_db DB_USER=root DB_PASSWORD=tu_contraseña PORT=3000 JWT_SECRET=cualquier_palabra_secreta
